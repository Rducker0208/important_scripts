...
cd /mnt/c/Users/ducke/PycharmProjects/TuneTransfer
...
new_file=`ls -At /mnt/c/users/ducke/PycharmProjects/TuneTransfer/bin | sed -n 2p`
...
new_file_name="TuneTransfer-$rework.$major.$minor"
echo -e "\e[36mcreated new file:\n$new_file_name"

# // delete oldest file in folder to make sure only 3 apks are saved at a time
oldest_file=`ls -rt /mnt/c/users/ducke/PycharmProjects/TuneTransfer/bin | sed -n 1p`
oldest_file=${oldest_file%.*}

rm /mnt/c/users/ducke/PycharmProjects/TuneTransfer/bin/${oldest_file}.apk
echo -e "\e[36mdeleted old file:\n$oldest_file.apk"

# // find the newly created file and remove it's .apk extension
new_file=`ls -t /mnt/c/users/ducke/PycharmProjects/TuneTransfer/bin | sed -n 1p`
new_file=${new_file%.*}

echo -e "\e[36mfound new created file:\n$new_file.apk"
echo -e "\e[36mmoving content from $new_file to $new_file_name"

mv /mnt/c/users/ducke/PycharmProjects/TuneTransfer/bin/${new_file}.apk /mnt/c/users/ducke/PycharmProjects/TuneTransfer/bin/${new_file_name}.apk

echo -e "\e[35mfinished building, starting upload to google drive\e[36m"
# echo -e "\e[36m"

# // use gdrive to upload file to google drive account
gdrive files upload --parent 1ZdfWQ0sKfNs-VNo1rKjxmUD8zYycrCs2 /mnt/c/users/ducke/PycharmProjects/TuneTransfer/bin/${new_file_name}.apk

# // get file info of oldest file in google drive directory and delete it
file_info=`gdrive files list --parent 1ZdfWQ0sKfNs-VNo1rKjxmUD8zYycrCs2 | sed -n 5p`
